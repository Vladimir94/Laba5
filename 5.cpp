...
void main()
{
	...
	while(1)
	{
		...
		case 2:								//Óäàëåíèå êîìàíäû
			...
			a[c].DeleteTeam();
			break;
		case 3:								//Ðàñïå÷àòêà èíôîðìàöèè î êîìàíäàõ â ëèãå
			printf("Select league\n");
			scanf("%d",&c);
			if(checkc(c))
			{
			...
			printf("**************************************\n");
			break;
		case 4:									//Ðàñïå÷àòêà èíôîðìàöèè î ëèãå
			printf("Select league\n");
			scanf("%d",&c);
			if(checkc(c))
			{

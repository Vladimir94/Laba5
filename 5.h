...
class TEAM					//Êëàññ êîìàíäà
{

	char NameOfTeam[25];	//Íàçâàíèå êîìàíäû
	int NumberOfPlayers;	//Êîëè÷åñòâî èãðîêîâ â êîìàíäå
	int AverageSalary;		//Ñðåäíÿÿ çàðïëàòà â êîìàíäå
	int NumberOfWins;		//Êîëè÷åñòâî ïîáåä êîìàíäû
	int NumberOfLoses;		//Êîëè÷åñòâî ïîðàæåíèé
...
class LEAGUE					//Êëàññ ëèãà
{
	char NameOfLeague[25];		//Íàçâàíèå ëèãè
	int NumberOfTeams;			//Êîëè÷åñòâî êîìàíä
	double AverageSalary;		//Ñðåäíÿÿ çàðïëàòà ïî ëèãå
	int NumberOfPlayers;		//Êîëè÷åñòâî èãðîêîâ â ëèãå
	TEAM team[10];				//Êîìàíäû ëèãè
